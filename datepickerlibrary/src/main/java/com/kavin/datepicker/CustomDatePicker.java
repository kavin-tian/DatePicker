...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    public void hideDate() {
        mPickerDialog.findViewById(R.id.tv_year_unit).setVisibility(View.GONE);
        mPickerDialog.findViewById(R.id.tv_month_unit).setVisibility(View.GONE);
        mPickerDialog.findViewById(R.id.tv_day_unit).setVisibility(View.GONE);
